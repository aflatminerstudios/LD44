...
boat = instance_create_depth(menuItems[0].x, 200, depth - 1, objUpgradeBoat);
claw = instance_create_depth(menuItems[0].x, 200 + boat.sprite_height/2, depth - 1, objUpgradeClaw);
